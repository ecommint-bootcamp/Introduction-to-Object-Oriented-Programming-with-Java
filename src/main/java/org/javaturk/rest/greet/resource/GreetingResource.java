...
public class GreetingResource {
	...
	public ResponseEntity<Object> createGreetingByParameter(@PathVariable("language") String language,
	...
	public ResponseEntity<Greeting> updateGreeting(@PathVariable("language") String language,
			@PathVariable("greeting") String greeting) {
		try {
			Greeting updatedGreeting = repo.update(language, greeting);
	...
	public ResponseEntity<Greeting> deleteGreeting(@PathVariable("language") String language) {
		try {
			Greeting deletedGreeting = repo.delete(language);
