package com.example.springrestgreeting.src.main.java.org.javaturk.rest.greet.resource;
...
import com.example.springrestgreeting.src.main.java.org.javaturk.rest.greet.domain.Greeting;
import com.example.springrestgreeting.src.main.java.org.javaturk.rest.greet.repo.GreetingRepository;
...
public class GreetingResource {
	...
	public ResponseEntity replaceGreetingByParameter(@PathVariable("language") String language, @PathVariable("greeting") String greeting) {
		...
		if (repo.contains(language)) {
			...
			return ResponseEntity.status(HttpStatus.CREATED).body(greetingObject);
		}
	}


	@DeleteMapping("{language}")
	public ResponseEntity deleteGreeting(@PathVariable("language") String language) {
