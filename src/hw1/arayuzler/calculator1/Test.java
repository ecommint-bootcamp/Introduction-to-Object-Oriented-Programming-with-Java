...
try {
	CalculatorT1 calculator2 = new CalculatorT1(7);
	...
	calculator2.addFunction(new KupAlma());
    calculator2.addFunction(new Fibonacci());
	calculator2.listMathFunction();
	startCalculator(calculator2);

}catch (Exception e){
	System.out.println("Mis gibi hata aldiniz "); // Exceptionlar kolay valla. Yazilir hallederiz
}
