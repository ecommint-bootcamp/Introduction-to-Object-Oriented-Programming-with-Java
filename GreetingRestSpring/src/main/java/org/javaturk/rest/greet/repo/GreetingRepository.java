...
//		System.out.println("in getGreeting(String language) of GreetingRepository");
	...
	public boolean updateGreeting(String language, String greeting,String targetLanguage) {
		if (greetingMap.containsKey(targetLanguage)) {
			greetingMap.remove(targetLanguage);
			greetingMap.put(language,greeting);
			return true;
		} else
			return false;
	...
	public boolean updateGreeting(Greeting greeting,String language) {
		return updateGreeting(greeting.getLanguage(), greeting.getGreeting(),language);
	}
